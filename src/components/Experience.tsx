                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    >
                        ...
                        <div className="border-l-2 border-gray-700 ml-3 pl-8 pb-8 relative">
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-gray-100">Project Experience</h4>
                                <span className="text-sm text-blue-400">01/2025 – Present</span>
                                <ul className="mt-4 space-y-2 text-gray-400 list-disc pl-4">
                                    <li>Built and deployed static and dynamic web applications using React, Node.js, and MongoDB.</li>
                                    <li>Integrated REST APIs, authentication, authorization, and payment gateways.</li>
                                    <li>Supported containerized and cloud deployments using Docker, AWS, and Nginx.</li>
                                    <li>Assisted junior learners with coding interviews and DSA preparation.</li>
                                </ul>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="space-y-8">
                            <div className="border-l-2 border-gray-700 ml-3 pl-8 relative">
                                ...
                                <div>
                                    <h4 className="text-xl font-bold text-gray-100">MERN Stack Development</h4>
                                    <p className="text-gray-300">Brototype, Kochi, Kerala</p>
                                    <span className="text-sm text-purple-400">2024 – 2025</span>
                                </div>
                            </div>
                            ...
                            <div className="border-l-2 border-gray-700 ml-3 pl-8 relative">
                                <span className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-purple-500"></span>
                                <div>
                                    <h4 className="text-xl font-bold text-gray-100">Bachelor of Science (BSc) – Forensic Science</h4>
                                    <p className="text-gray-300">Yenepoya University / YIASCM College, Mangalore</p>
